...
$array['dashboard_widgets'][$x]['widget_column_span'] = '4';
$array['dashboard_widgets'][$x]['widget_row_span'] = '2';
$array['dashboard_widgets'][$x]['widget_details_state'] = 'visible';
$array['dashboard_widgets'][$x]['widget_order'] = '0';
$array['dashboard_widgets'][$x]['widget_enabled'] = 'true';
$array['dashboard_widgets'][$x]['widget_description'] = 'Notes for Domains';
$y = 0;
